...
- Release needs `permissions.workflows: write` — else `changesets/action` tag push is rejected when the tip touches `.github/workflows/*` (npm may already have published).
