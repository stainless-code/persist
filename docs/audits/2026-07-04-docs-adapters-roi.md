...
| 26  | Preact + Angular-signals hydration adapters.                                                                                    | S each |
| 27  | FAQ / troubleshooting page — lift from `skill:141` + "why does my UI flash" + "IDB cross-tab isn't syncing" + "quota exceeded". | S      |
